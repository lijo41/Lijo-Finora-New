...
import { Upload, Search, MessageCircle, FileText, Receipt } from 'lucide-react'
...
function App() {
  const [activeTab, setActiveTab] = React.useState<'upload' | 'search' | 'chat' | 'gstr1'>('upload')
